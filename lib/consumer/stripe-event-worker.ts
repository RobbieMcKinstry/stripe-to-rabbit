...
export abstract class StripeEventWorker {
  ...
  protected async handleAccountApplicationAuthorized(
    event: Stripe.AccountApplicationAuthorizedEvent
  ): Promise<void> {}
  protected async handleAccountApplicationDeauthorized(
    event: Stripe.AccountApplicationDeauthorizedEvent
  ): Promise<void> {}
  protected async handleAccountExternalAccountCreated(
    event: Stripe.AccountExternalAccountCreatedEvent
  ): Promise<void> {}
  protected async handleAccountExternalAccountDeleted(
    event: Stripe.AccountExternalAccountDeletedEvent
  ): Promise<void> {}
  protected async handleAccountExternalAccountUpdated(
  ...
  protected async handleApplicationFeeCreated(
    event: Stripe.ApplicationFeeCreatedEvent
  ): Promise<void> {}
  protected async handleApplicationFeeRefundUpdated(
    event: Stripe.ApplicationFeeRefundUpdatedEvent
  ): Promise<void> {}
  protected async handleApplicationFeeRefunded(
    event: Stripe.ApplicationFeeRefundedEvent
  ): Promise<void> {}
  protected async handleBalanceAvailable(event: Stripe.BalanceAvailableEvent): Promise<void> {}
  protected async handleBalanceSettingsUpdated(
    event: Stripe.BalanceSettingsUpdatedEvent
  ): Promise<void> {}
  protected async handleBillingAlertTriggered(
    event: Stripe.BillingAlertTriggeredEvent
  ): Promise<void> {}
  protected async handleBillingPortalConfigurationCreated(
    event: Stripe.BillingPortalConfigurationCreatedEvent
  ): Promise<void> {}
  protected async handleBillingPortalConfigurationUpdated(
    event: Stripe.BillingPortalConfigurationUpdatedEvent
  ): Promise<void> {}
  protected async handleBillingPortalSessionCreated(
    event: Stripe.BillingPortalSessionCreatedEvent
  ): Promise<void> {}
  protected async handleCapabilityUpdated(event: Stripe.CapabilityUpdatedEvent): Promise<void> {}
  protected async handleCashBalanceFundsAvailable(
    event: Stripe.CashBalanceFundsAvailableEvent
  ): Promise<void> {}
  protected async handleChargeCaptured(event: Stripe.ChargeCapturedEvent): Promise<void> {}
  protected async handleChargeDisputeClosed(
    event: Stripe.ChargeDisputeClosedEvent
  ): Promise<void> {}
  protected async handleChargeDisputeCreated(
    event: Stripe.ChargeDisputeCreatedEvent
  ): Promise<void> {}
  protected async handleChargeDisputeFundsReinstated(
    event: Stripe.ChargeDisputeFundsReinstatedEvent
  ): Promise<void> {}
  protected async handleChargeDisputeFundsWithdrawn(
    event: Stripe.ChargeDisputeFundsWithdrawnEvent
  ): Promise<void> {}
  protected async handleChargeDisputeUpdated(
  ...
  protected async handleChargeRefundUpdated(
    event: Stripe.ChargeRefundUpdatedEvent
  ): Promise<void> {}
  ...
  protected async handleCheckoutSessionAsyncPaymentFailed(
    event: Stripe.CheckoutSessionAsyncPaymentFailedEvent
  ): Promise<void> {}
  protected async handleCheckoutSessionAsyncPaymentSucceeded(
    event: Stripe.CheckoutSessionAsyncPaymentSucceededEvent
  ): Promise<void> {}
  protected async handleCheckoutSessionCompleted(
    event: Stripe.CheckoutSessionCompletedEvent
  ): Promise<void> {}
  protected async handleCheckoutSessionExpired(
    event: Stripe.CheckoutSessionExpiredEvent
  ): Promise<void> {}
  protected async handleClimateOrderCanceled(
    event: Stripe.ClimateOrderCanceledEvent
  ): Promise<void> {}
  protected async handleClimateOrderCreated(
    event: Stripe.ClimateOrderCreatedEvent
  ): Promise<void> {}
  protected async handleClimateOrderDelayed(
    event: Stripe.ClimateOrderDelayedEvent
  ): Promise<void> {}
  protected async handleClimateOrderDelivered(
    event: Stripe.ClimateOrderDeliveredEvent
  ): Promise<void> {}
  protected async handleClimateOrderProductSubstituted(
    event: Stripe.ClimateOrderProductSubstitutedEvent
  ): Promise<void> {}
  protected async handleClimateProductCreated(
    event: Stripe.ClimateProductCreatedEvent
  ): Promise<void> {}
  protected async handleClimateProductPricingUpdated(
    event: Stripe.ClimateProductPricingUpdatedEvent
  ): Promise<void> {}
  ...
  protected async handleCustomerDiscountCreated(
    event: Stripe.CustomerDiscountCreatedEvent
  ): Promise<void> {}
  protected async handleCustomerDiscountDeleted(
    event: Stripe.CustomerDiscountDeletedEvent
  ): Promise<void> {}
  protected async handleCustomerDiscountUpdated(
    event: Stripe.CustomerDiscountUpdatedEvent
  ): Promise<void> {}
  protected async handleCustomerSourceCreated(
    event: Stripe.CustomerSourceCreatedEvent
  ): Promise<void> {}
  protected async handleCustomerSourceDeleted(
    event: Stripe.CustomerSourceDeletedEvent
  ): Promise<void> {}
  protected async handleCustomerSourceExpiring(
    event: Stripe.CustomerSourceExpiringEvent
  ): Promise<void> {}
  protected async handleCustomerSourceUpdated(
    event: Stripe.CustomerSourceUpdatedEvent
  ): Promise<void> {}
  ...
  protected async handleCustomerSubscriptionPaused(
    event: Stripe.CustomerSubscriptionPausedEvent
  ): Promise<void> {}
  protected async handleCustomerSubscriptionPendingUpdateApplied(
    event: Stripe.CustomerSubscriptionPendingUpdateAppliedEvent
  ): Promise<void> {}
  protected async handleCustomerSubscriptionPendingUpdateExpired(
    event: Stripe.CustomerSubscriptionPendingUpdateExpiredEvent
  ): Promise<void> {}
  protected async handleCustomerSubscriptionResumed(
  ...
  protected async handleCustomerTaxIdCreated(
    event: Stripe.CustomerTaxIdCreatedEvent
  ): Promise<void> {}
  protected async handleCustomerTaxIdDeleted(
    event: Stripe.CustomerTaxIdDeletedEvent
  ): Promise<void> {}
  protected async handleCustomerTaxIdUpdated(
    event: Stripe.CustomerTaxIdUpdatedEvent
  ): Promise<void> {}
  protected async handleCustomerUpdated(event: Stripe.CustomerUpdatedEvent): Promise<void> {}
  protected async handleCustomerCashBalanceTransactionCreated(
    event: Stripe.CustomerCashBalanceTransactionCreatedEvent
  ): Promise<void> {}
  protected async handleEntitlementsActiveEntitlementSummaryUpdated(
    event: Stripe.EntitlementsActiveEntitlementSummaryUpdatedEvent
  ): Promise<void> {}
  protected async handleFileCreated(event: Stripe.FileCreatedEvent): Promise<void> {}
  protected async handleFinancialConnectionsAccountAccountNumbersUpdated(
    event: Stripe.FinancialConnectionsAccountAccountNumbersUpdatedEvent
  ): Promise<void> {}
  protected async handleFinancialConnectionsAccountCreated(
    event: Stripe.FinancialConnectionsAccountCreatedEvent
  ): Promise<void> {}
  protected async handleFinancialConnectionsAccountDeactivated(
    event: Stripe.FinancialConnectionsAccountDeactivatedEvent
  ): Promise<void> {}
  protected async handleFinancialConnectionsAccountDisconnected(
    event: Stripe.FinancialConnectionsAccountDisconnectedEvent
  ): Promise<void> {}
  protected async handleFinancialConnectionsAccountReactivated(
    event: Stripe.FinancialConnectionsAccountReactivatedEvent
  ): Promise<void> {}
  protected async handleFinancialConnectionsAccountRefreshedBalance(
    event: Stripe.FinancialConnectionsAccountRefreshedBalanceEvent
  ): Promise<void> {}
  protected async handleFinancialConnectionsAccountRefreshedOwnership(
    event: Stripe.FinancialConnectionsAccountRefreshedOwnershipEvent
  ): Promise<void> {}
  protected async handleFinancialConnectionsAccountRefreshedTransactions(
    event: Stripe.FinancialConnectionsAccountRefreshedTransactionsEvent
  ): Promise<void> {}
  protected async handleFinancialConnectionsAccountUpcomingAccountNumberExpiry(
    event: Stripe.FinancialConnectionsAccountUpcomingAccountNumberExpiryEvent
  ): Promise<void> {}
  protected async handleIdentityVerificationSessionCanceled(
    event: Stripe.IdentityVerificationSessionCanceledEvent
  ): Promise<void> {}
  protected async handleIdentityVerificationSessionCreated(
    event: Stripe.IdentityVerificationSessionCreatedEvent
  ): Promise<void> {}
  protected async handleIdentityVerificationSessionProcessing(
    event: Stripe.IdentityVerificationSessionProcessingEvent
  ): Promise<void> {}
  protected async handleIdentityVerificationSessionRedacted(
    event: Stripe.IdentityVerificationSessionRedactedEvent
  ): Promise<void> {}
  protected async handleIdentityVerificationSessionRequiresInput(
    event: Stripe.IdentityVerificationSessionRequiresInputEvent
  ): Promise<void> {}
  protected async handleIdentityVerificationSessionVerified(
    event: Stripe.IdentityVerificationSessionVerifiedEvent
  ): Promise<void> {}
  ...
  protected async handleInvoiceFinalizationFailed(
  ...
  protected async handleInvoiceMarkedUncollectible(
    event: Stripe.InvoiceMarkedUncollectibleEvent
  ): Promise<void> {}
  ...
  protected async handleInvoicePaymentActionRequired(
    event: Stripe.InvoicePaymentActionRequiredEvent
  ): Promise<void> {}
  protected async handleInvoicePaymentAttemptRequired(
    event: Stripe.InvoicePaymentAttemptRequiredEvent
  ): Promise<void> {}
  ...
  protected async handleIssuingAuthorizationCreated(
    event: Stripe.IssuingAuthorizationCreatedEvent
  ): Promise<void> {}
  protected async handleIssuingAuthorizationRequest(
    event: Stripe.IssuingAuthorizationRequestEvent
  ): Promise<void> {}
  protected async handleIssuingAuthorizationUpdated(
    event: Stripe.IssuingAuthorizationUpdatedEvent
  ): Promise<void> {}
  ...
  protected async handleIssuingCardholderCreated(
    event: Stripe.IssuingCardholderCreatedEvent
  ): Promise<void> {}
  protected async handleIssuingCardholderUpdated(
    event: Stripe.IssuingCardholderUpdatedEvent
  ): Promise<void> {}
  protected async handleIssuingDisputeClosed(
    event: Stripe.IssuingDisputeClosedEvent
  ): Promise<void> {}
  protected async handleIssuingDisputeCreated(
    event: Stripe.IssuingDisputeCreatedEvent
  ): Promise<void> {}
  protected async handleIssuingDisputeFundsReinstated(
    event: Stripe.IssuingDisputeFundsReinstatedEvent
  ): Promise<void> {}
  protected async handleIssuingDisputeFundsRescinded(
    event: Stripe.IssuingDisputeFundsRescindedEvent
  ): Promise<void> {}
  protected async handleIssuingDisputeSubmitted(
    event: Stripe.IssuingDisputeSubmittedEvent
  ): Promise<void> {}
  protected async handleIssuingDisputeUpdated(
    event: Stripe.IssuingDisputeUpdatedEvent
  ): Promise<void> {}
  protected async handleIssuingPersonalizationDesignActivated(
    event: Stripe.IssuingPersonalizationDesignActivatedEvent
  ): Promise<void> {}
  protected async handleIssuingPersonalizationDesignDeactivated(
    event: Stripe.IssuingPersonalizationDesignDeactivatedEvent
  ): Promise<void> {}
  protected async handleIssuingPersonalizationDesignRejected(
    event: Stripe.IssuingPersonalizationDesignRejectedEvent
  ): Promise<void> {}
  protected async handleIssuingPersonalizationDesignUpdated(
    event: Stripe.IssuingPersonalizationDesignUpdatedEvent
  ): Promise<void> {}
  protected async handleIssuingTokenCreated(
    event: Stripe.IssuingTokenCreatedEvent
  ): Promise<void> {}
  protected async handleIssuingTokenUpdated(
    event: Stripe.IssuingTokenUpdatedEvent
  ): Promise<void> {}
  protected async handleIssuingTransactionCreated(
    event: Stripe.IssuingTransactionCreatedEvent
  ): Promise<void> {}
  protected async handleIssuingTransactionPurchaseDetailsReceiptUpdated(
    event: Stripe.IssuingTransactionPurchaseDetailsReceiptUpdatedEvent
  ): Promise<void> {}
  protected async handleIssuingTransactionUpdated(
    event: Stripe.IssuingTransactionUpdatedEvent
  ): Promise<void> {}
  protected async handleMandateUpdated(event: Stripe.MandateUpdatedEvent): Promise<void> {}
  protected async handlePaymentIntentAmountCapturableUpdated(
    event: Stripe.PaymentIntentAmountCapturableUpdatedEvent
  ): Promise<void> {}
  protected async handlePaymentIntentCanceled(
    event: Stripe.PaymentIntentCanceledEvent
  ): Promise<void> {}
  protected async handlePaymentIntentCreated(
    event: Stripe.PaymentIntentCreatedEvent
  ): Promise<void> {}
  protected async handlePaymentIntentPartiallyFunded(
    event: Stripe.PaymentIntentPartiallyFundedEvent
  ): Promise<void> {}
  protected async handlePaymentIntentPaymentFailed(
    event: Stripe.PaymentIntentPaymentFailedEvent
  ): Promise<void> {}
  protected async handlePaymentIntentProcessing(
    event: Stripe.PaymentIntentProcessingEvent
  ): Promise<void> {}
  protected async handlePaymentIntentRequiresAction(
  ...
  protected async handlePaymentMethodAttached(
    event: Stripe.PaymentMethodAttachedEvent
  ): Promise<void> {}
  protected async handlePaymentMethodAutomaticallyUpdated(
    event: Stripe.PaymentMethodAutomaticallyUpdatedEvent
  ): Promise<void> {}
  protected async handlePaymentMethodDetached(
    event: Stripe.PaymentMethodDetachedEvent
  ): Promise<void> {}
  protected async handlePaymentMethodUpdated(
    event: Stripe.PaymentMethodUpdatedEvent
  ): Promise<void> {}
  ...
  protected async handlePayoutReconciliationCompleted(
    event: Stripe.PayoutReconciliationCompletedEvent
  ): Promise<void> {}
  ...
  protected async handlePromotionCodeCreated(
    event: Stripe.PromotionCodeCreatedEvent
  ): Promise<void> {}
  protected async handlePromotionCodeUpdated(
  ...
  protected async handleRadarEarlyFraudWarningCreated(
    event: Stripe.RadarEarlyFraudWarningCreatedEvent
  ): Promise<void> {}
  protected async handleRadarEarlyFraudWarningUpdated(
    event: Stripe.RadarEarlyFraudWarningUpdatedEvent
  ): Promise<void> {}
  ...
  protected async handleReportingReportRunFailed(
    event: Stripe.ReportingReportRunFailedEvent
  ): Promise<void> {}
  protected async handleReportingReportRunSucceeded(
    event: Stripe.ReportingReportRunSucceededEvent
  ): Promise<void> {}
  protected async handleReportingReportTypeUpdated(
    event: Stripe.ReportingReportTypeUpdatedEvent
  ): Promise<void> {}
  ...
  protected async handleSetupIntentCanceled(
    event: Stripe.SetupIntentCanceledEvent
  ): Promise<void> {}
  protected async handleSetupIntentCreated(event: Stripe.SetupIntentCreatedEvent): Promise<void> {}
  protected async handleSetupIntentRequiresAction(
    event: Stripe.SetupIntentRequiresActionEvent
  ): Promise<void> {}
  protected async handleSetupIntentSetupFailed(
    event: Stripe.SetupIntentSetupFailedEvent
  ): Promise<void> {}
  protected async handleSetupIntentSucceeded(
    event: Stripe.SetupIntentSucceededEvent
  ): Promise<void> {}
  protected async handleSigmaScheduledQueryRunCreated(
    event: Stripe.SigmaScheduledQueryRunCreatedEvent
  ): Promise<void> {}
  ...
  protected async handleSourceMandateNotification(
    event: Stripe.SourceMandateNotificationEvent
  ): Promise<void> {}
  protected async handleSourceRefundAttributesRequired(
    event: Stripe.SourceRefundAttributesRequiredEvent
  ): Promise<void> {}
  protected async handleSourceTransactionCreated(
    event: Stripe.SourceTransactionCreatedEvent
  ): Promise<void> {}
  protected async handleSourceTransactionUpdated(
    event: Stripe.SourceTransactionUpdatedEvent
  ): Promise<void> {}
  protected async handleSubscriptionScheduleAborted(
    event: Stripe.SubscriptionScheduleAbortedEvent
  ): Promise<void> {}
  protected async handleSubscriptionScheduleCanceled(
    event: Stripe.SubscriptionScheduleCanceledEvent
  ): Promise<void> {}
  protected async handleSubscriptionScheduleCompleted(
    event: Stripe.SubscriptionScheduleCompletedEvent
  ): Promise<void> {}
  protected async handleSubscriptionScheduleCreated(
    event: Stripe.SubscriptionScheduleCreatedEvent
  ): Promise<void> {}
  protected async handleSubscriptionScheduleExpiring(
    event: Stripe.SubscriptionScheduleExpiringEvent
  ): Promise<void> {}
  protected async handleSubscriptionScheduleReleased(
    event: Stripe.SubscriptionScheduleReleasedEvent
  ): Promise<void> {}
  protected async handleSubscriptionScheduleUpdated(
  ...
  protected async handleTerminalReaderActionFailed(
    event: Stripe.TerminalReaderActionFailedEvent
  ): Promise<void> {}
  protected async handleTerminalReaderActionSucceeded(
    event: Stripe.TerminalReaderActionSucceededEvent
  ): Promise<void> {}
  protected async handleTerminalReaderActionUpdated(
    event: Stripe.TerminalReaderActionUpdatedEvent
  ): Promise<void> {}
  protected async handleTestHelpersTestClockAdvancing(
    event: Stripe.TestHelpersTestClockAdvancingEvent
  ): Promise<void> {}
  protected async handleTestHelpersTestClockCreated(
    event: Stripe.TestHelpersTestClockCreatedEvent
  ): Promise<void> {}
  protected async handleTestHelpersTestClockDeleted(
    event: Stripe.TestHelpersTestClockDeletedEvent
  ): Promise<void> {}
  protected async handleTestHelpersTestClockInternalFailure(
    event: Stripe.TestHelpersTestClockInternalFailureEvent
  ): Promise<void> {}
  protected async handleTestHelpersTestClockReady(
  ...
  protected async handleTreasuryCreditReversalCreated(
    event: Stripe.TreasuryCreditReversalCreatedEvent
  ): Promise<void> {}
  protected async handleTreasuryCreditReversalPosted(
    event: Stripe.TreasuryCreditReversalPostedEvent
  ): Promise<void> {}
  protected async handleTreasuryDebitReversalCompleted(
    event: Stripe.TreasuryDebitReversalCompletedEvent
  ): Promise<void> {}
  protected async handleTreasuryDebitReversalCreated(
    event: Stripe.TreasuryDebitReversalCreatedEvent
  ): Promise<void> {}
  protected async handleTreasuryDebitReversalInitialCreditGranted(
    event: Stripe.TreasuryDebitReversalInitialCreditGrantedEvent
  ): Promise<void> {}
  protected async handleTreasuryFinancialAccountClosed(
    event: Stripe.TreasuryFinancialAccountClosedEvent
  ): Promise<void> {}
  protected async handleTreasuryFinancialAccountCreated(
    event: Stripe.TreasuryFinancialAccountCreatedEvent
  ): Promise<void> {}
  protected async handleTreasuryFinancialAccountFeaturesStatusUpdated(
    event: Stripe.TreasuryFinancialAccountFeaturesStatusUpdatedEvent
  ): Promise<void> {}
  protected async handleTreasuryInboundTransferCanceled(
    event: Stripe.TreasuryInboundTransferCanceledEvent
  ): Promise<void> {}
  protected async handleTreasuryInboundTransferCreated(
    event: Stripe.TreasuryInboundTransferCreatedEvent
  ): Promise<void> {}
  protected async handleTreasuryInboundTransferFailed(
    event: Stripe.TreasuryInboundTransferFailedEvent
  ): Promise<void> {}
  protected async handleTreasuryInboundTransferSucceeded(
    event: Stripe.TreasuryInboundTransferSucceededEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundPaymentCanceled(
    event: Stripe.TreasuryOutboundPaymentCanceledEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundPaymentCreated(
    event: Stripe.TreasuryOutboundPaymentCreatedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundPaymentExpectedArrivalDateUpdated(
    event: Stripe.TreasuryOutboundPaymentExpectedArrivalDateUpdatedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundPaymentFailed(
    event: Stripe.TreasuryOutboundPaymentFailedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundPaymentPosted(
    event: Stripe.TreasuryOutboundPaymentPostedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundPaymentReturned(
    event: Stripe.TreasuryOutboundPaymentReturnedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundPaymentTrackingDetailsUpdated(
    event: Stripe.TreasuryOutboundPaymentTrackingDetailsUpdatedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundTransferCanceled(
    event: Stripe.TreasuryOutboundTransferCanceledEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundTransferCreated(
    event: Stripe.TreasuryOutboundTransferCreatedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundTransferExpectedArrivalDateUpdated(
    event: Stripe.TreasuryOutboundTransferExpectedArrivalDateUpdatedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundTransferFailed(
    event: Stripe.TreasuryOutboundTransferFailedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundTransferPosted(
    event: Stripe.TreasuryOutboundTransferPostedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundTransferReturned(
    event: Stripe.TreasuryOutboundTransferReturnedEvent
  ): Promise<void> {}
  protected async handleTreasuryOutboundTransferTrackingDetailsUpdated(
    event: Stripe.TreasuryOutboundTransferTrackingDetailsUpdatedEvent
  ): Promise<void> {}
  protected async handleTreasuryReceivedCreditCreated(
    event: Stripe.TreasuryReceivedCreditCreatedEvent
  ): Promise<void> {}
  protected async handleTreasuryReceivedCreditFailed(
    event: Stripe.TreasuryReceivedCreditFailedEvent
  ): Promise<void> {}
  protected async handleTreasuryReceivedCreditSucceeded(
    event: Stripe.TreasuryReceivedCreditSucceededEvent
  ): Promise<void> {}
  protected async handleTreasuryReceivedDebitCreated(
    event: Stripe.TreasuryReceivedDebitCreatedEvent
  ): Promise<void> {}
  protected async handleBillingCreditBalanceTransactionCreated(
    event: Stripe.BillingCreditBalanceTransactionCreatedEvent
  ): Promise<void> {}
  protected async handleBillingCreditGrantCreated(
    event: Stripe.BillingCreditGrantCreatedEvent
  ): Promise<void> {}
  protected async handleBillingCreditGrantUpdated(
    event: Stripe.BillingCreditGrantUpdatedEvent
  ): Promise<void> {}
  protected async handleBillingMeterCreated(
    event: Stripe.BillingMeterCreatedEvent
  ): Promise<void> {}
  protected async handleBillingMeterDeactivated(
    event: Stripe.BillingMeterDeactivatedEvent
  ): Promise<void> {}
  protected async handleBillingMeterReactivated(
    event: Stripe.BillingMeterReactivatedEvent
  ): Promise<void> {}
  protected async handleBillingMeterUpdated(
    event: Stripe.BillingMeterUpdatedEvent
  ): Promise<void> {}
}
